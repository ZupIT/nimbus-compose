...
val components: Map<String, @Composable (element: ServerDrivenNode, children: @Composable () -> Unit) -> Unit> = mapOf(
    "material:text" to @Composable { element, _ -> BeagleText(element.parse(object : TypeReference<BeagleTextModel>() {})) },
